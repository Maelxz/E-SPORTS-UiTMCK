...
<head>
   ...
   <title>E SPORTS CLUB UiTMCK (ESC UiTMCK)</title>
</head>

<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00000000;">
     E SPORTS CLUB UiTMCK (ESC UiTMCK)
   </nav>
